...
describe('Test Case 14: Place Order with Register during Checkout', () => {
  ...
  test('Place order with registration during checkout', async () => {
    ...
    const continueButton = await driver.findElement(By.xpath('//button[text()="Continue Shopping"]'));
    ...
    await driver.findElement(By.xpath('//a[@href="/view_cart"]')).click();
    ...
    await driver.wait(until.elementIsEnabled(driver.findElement(By.id('id_gender1'))), 10000);
